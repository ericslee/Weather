...
@implementation ESLCoreDataManager
...
+ (ESLCoreDataManager*)sharedInstance
{
    ...
    static ESLCoreDataManager *_sharedInstance = nil;
    
    // ensures initialization code executes only once
    static dispatch_once_t oncePredicate;
    
    dispatch_once(&oncePredicate, ^{
        _sharedInstance = [[ESLCoreDataManager alloc] init];
    });
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"EricWeather.sqlite"];
